(function (global, factory) {
	...
	var functionBindContext$1 = function (fn, that) {
	  aCallable$b(fn);
	  return that === undefined ? fn : bind$j ? bind$j(fn, that) : function (/* ...args */) {
	...
	*/
	...
	var MAX_REQUEST_TIMES = 20; // 請求次數超過最大限制回應訊息
	...
	var httpRequset = function httpRequset(config) {
	  ...
	  var newOptions = keyExists ? {} : deepMerge(baseConfig, isPlainObject_1(config) && config); //eslint-disable-line
	...
	var TokenInjection = /*#__PURE__*/function () {
	  ...
	  function TokenInjection() {
	    ...
	    this.intervalRefresh = null; // 自動同步/刷新 Token 請求次數計數

	    this.syncTimes = 0;
	    this.refreshTimes = 0; // 實例化 axios
	    ...
	    value: function sync() {
	      ...
	      return new promise(function (resolve, reject) {
	        rest.get(api.sync).then(function (res) {
	          ...
	          res.syncTimes = instance.syncTimes; // 設置 Token Keys (LocalStorage)
	      ...
	      while (1) {
	        switch (_context7.prev = _context7.next) {
	          case 0:
	            ...
	            instance.intervalSync = null;
	            instance.intervalRefresh = null; // 自動同步/刷新 Token 請求次數歸零
